...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextMonthButton = $('<td><a href="#" class="button-month-next"><i class="ion ion-ios-arrow-forward" aria-hidden="true"></i></a></td>');
            //event
            ...
            var previousMonthButton = $('<td><a href="#" class="button-month-previous"><i class="ion ion-ios-arrow-back" aria-hidden="true"></i></a></td>');
            //event
        ...
        function markEvents(month, year) {
            ...
            for (var i = 0; i < events.length; i++) {
                ...
                if (events[i].date.split('/')[1] == temporalMonth && events[i].date.split('/')[2] == year) {
                    ...
                    //class
                    if (events[i].EditionID)
                        loopDayA.attr('editionid', events[i].EditionID);
